...
class Tx_Phpunit_ViewHelpers_ExtensionSelectorViewHelperTest extends Tx_Phpunit_TestCase {
	...
	public function renderCreatesTwoOptionTagsWithOneExtension() {
		...
		$testable->setIconPath(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($extensionKey) . 'ext_icon.gif');
	...
	public function renderCreatesThreeOptionTagsWithTwoExtensions() {
		...
		$testable1->setIconPath(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($extensionKey1) . 'ext_icon.gif');

		$extensionKey2 = 'cms';
		$testable2 = new Tx_Phpunit_Testable();
		$testable2->setKey($extensionKey2);
		$testable1->setIconPath(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($extensionKey2) . 'ext_icon.gif');
