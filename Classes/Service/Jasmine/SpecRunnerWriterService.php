...
class Tx_Phpunit_Service_Jasmine_SpecRunnerWriterService {
	...
	public function writeSpecRunner($extKey, array $testDefinitionIncludes, array $includes, $type) {
		$this->view->setTemplatePathAndFilename(t3lib_extMgm::extPath('phpunit', 'Resources/Private/Standalone/JasmineSpecRunner.html'));
	...
	private function writeSpecRunnerToTempdirectory($extKey, $type, $content) {
		try {
			...
			$filename = 'typo3temp/tx_phpunit/jasmine/' . $type . '_' . t3lib_div::shortMD5($extKey) . '.html';
