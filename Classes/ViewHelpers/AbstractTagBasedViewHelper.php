 ...
 */
abstract class Tx_Phpunit_ViewHelpers_AbstractTagBasedViewHelper extends Tx_Phpunit_ViewHelpers_AbstractViewHelper
{
    /**
     ...
     */
    protected function renderTag($tagName, $attributes, $content = '')
    {
        if (empty($tagName)) {
