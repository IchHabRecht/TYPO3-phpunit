...
class Tx_Phpunit_BackEnd_Module extends t3lib_SCbase {
	 ...
	 * This is important as PHPUnit only sets its error handler if nothing was set before,
	 * but typically an error handler is set during by TYPO3 during the initialisation.
	 *
	 * @return void
	 */
